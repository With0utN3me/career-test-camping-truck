    ...
    for (let i = 0; i < 5; i++) {
        stars.push(
            <svg
                ...
                className={clsx(
                    css["star-icon"], 
                    i < rating ? css["star-filled"] : css["star-empty"]
                )}
                aria-hidden="true"
            >
...
export const AdvertModal = ({ isOpen, onRequestClose, advert, context, setContext, handleExit }) => {
    ...
    return (
        ...
        <div className={css["modal-wrapper"]}>
            <div className={css["modal-main-info"]}>
                <div className={css["title-exit"]}>
                    <h3 className={css["title"]}>{advert.name}</h3>
                    <button className={css["exit-btn"]} onClick={handleExit}>
                        <svg className={css["exit-icon"]} viewBox="0 0 32 32" >
                            <use href={`${icons}#icon-close-modal`} />
                        </svg>
                    </button>
                </div>
                <div className={css["rating-location"]}>
                    <p className={css["rating-p"]}>
                        ...
                        <button className={css["reviews-link"]} onClick={() => setContext("reviews")} >{advert.rating}({advert.reviews.length} Reviews)</button>
                    </p>
                ...
                <h3 className={css["price"]}>€{advert.price}.00</h3>
            </div>
            <div className={css["images-wrap"]}>
                <div className={css["image-wrap"]}><img className={css["image"]} src={advert.gallery[0]} alt="Van photo" /></div>
                <div className={css["image-wrap"]}><img className={css["image"]} src={advert.gallery[1]} alt="Van photo" /></div>
                <div className={css["image-wrap"]}><img className={css["image"]} src={advert.gallery[2]} alt="Van photo" /></div>
                
                
                
            </div>
            <div className={css["description-wrap"]}>
                <p className={css["description"]}>{advert.description}</p>
            </div>
            <div className={css["full-details-wrap"]}>
                <div className={css["pick-context-wrap"]}>
                    <div className={clsx(css["btn-wrap"], context === "features" && css["active-btn-wrap"])}>
                        <button className={css["context-btn"]} onClick={() => setContext("features")}>Features</button>
                    </div>
                    <div className={clsx(css["btn-wrap"], context === "reviews" && css["active-btn-wrap"])}>
                        <button className={css["context-btn"]} onClick={() => setContext("reviews")}>Reviews</button>
                    </div>
                </div>
                <div className={css["context-wrap"]}>
                    {context === "features" && (
                        <div className={css["features-wrap"]}>
                            <ul className={css["features-list"]}>
                                <li className={css["feature"]}>
                                    <svg className={css["users-icon"]} aria-hidden="true">
                                ...
                                {advert.details.airConditioner > 0 && (
                                    <li className={css["feature"]}>
                                        <svg className={css["feature-icon"]} aria-hidden="true">
                                            <use href={`${icons}#icon-hotel-air-conditioner`} />
                                        </svg>
                                ...
                                {advert.details.CD > 0 && (
                                    <li className={css["feature"]}>
                                        <svg className={css["feature-icon"]} aria-hidden="true">
                                            <use href={`${icons}#icon-disc`} />
                                        </svg>
                                        CD
                                    </li>
                                )}

                                {advert.details.radio > 0 && (
                                    <li className={css["feature"]}>
                                        <svg className={css["feature-icon"]} aria-hidden="true">
                                            <use href={`${icons}#icon-radio-linear`} />
                                        </svg>
                                        Radio
                                    </li>
                                )}

                                {advert.details.hob > 0 && (
                                    <li className={css["feature"]}>
                                        <svg className={css["feature-icon"]} aria-hidden="true">
                                            <use href={`${icons}#icon-plate`} />
                                        </svg>
                                        {advert.details.hob} hob
                                    </li>
                                )}

                                {advert.details.toilet > 0 && (
                                    <li className={css["feature"]}>
                                        <svg className={css["toilet-icon"]} aria-hidden="true">
                                ...
                                {advert.details.freezer > 0 && (
                                    <li className={css["feature"]}>
                                        <svg className={css["feature-icon"]} aria-hidden="true">
                                            <use href={`${icons}#icon-freezer`} />
                                        </svg>
                                        Freezer
                                    </li>
                                )}
                                ...
                                {advert.details.gas !== "" && (
                                    <li className={css["feature"]}>
                                        <svg className={css["gas-icon"]} aria-hidden="true">
                            ...
                            <div className={css["van-details-wrap"]}>
                                <h3 className={css["van-details-title"]}>Vehicle details</h3>
                                <ul className={css["van-details-list"]}>
                                    <li className={css["van-detail"]}>
                                        <span className={css["detail-name"]}>Form</span>
                                        <span className={css["detail-value"]}>{advert.form}</span>
                                    </li>

                                    <li className={css["van-detail"]}>
                                        <span className={css["detail-name"]}>Length</span>
                                        <span className={css["detail-value"]}>{advert.length}</span>
                                    </li>

                                    <li className={css["van-detail"]}>
                                        <span className={css["detail-name"]}>Width</span>
                                        <span className={css["detail-value"]}>{advert.width}</span>
                                    </li>

                                    <li className={css["van-detail"]}>
                                        <span className={css["detail-name"]}>Height</span>
                                        <span className={css["detail-value"]}>{advert.height}</span>
                                    </li>

                                    <li className={css["van-detail"]}>
                                        <span className={css["detail-name"]}>Tank</span>
                                        <span className={css["detail-value"]}>{advert.tank}</span>
                                    </li>

                                    <li className={css["van-detail"]}>
                                        <span className={css["detail-name"]}>Consumption</span>
                                        <span className={css["detail-value"]}>{advert.consumption}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    {context === "reviews" && (
                        <ul className={css["reviews-list"]}>
                            {advert.reviews.map(review => {
                                return(
                                    <li key={nanoid()}>
                                        <div className={css["avatar-rating"]}>
                                            <div className={css["avatar"]}>
                                                {review.reviewer_name.charAt(0).toUpperCase()}
                                            </div>
                                            <div className={css["name-rating"]}>
                                                <h4>{review.reviewer_name}</h4>
                                                <div className={css["rating-stars"]}>
                                                    {context === "reviews" && renderStars(review.reviewer_rating)}
                                                </div>
                                            </div>
                                        </div>
                                        <p className={css["review-comment"]}>
                                            {review.comment}
                                        </p>
                                    </li>
                                )
